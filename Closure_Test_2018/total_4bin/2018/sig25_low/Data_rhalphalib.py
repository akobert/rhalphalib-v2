...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([120, 140, 160, 195, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins13[6] = {120, 140, 160, 195, 700};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins13, 40, 0, 2000)
