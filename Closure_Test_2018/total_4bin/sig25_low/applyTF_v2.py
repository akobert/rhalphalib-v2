...
def drawDiagnostic(name, ifile1):
	...
	ofile = ROOT.TFile("./TF_plots.root", "RECREATE")
        ...
        ROOT.gInterpreter.Declare("Double_t widebins_2016[6] = {200, 230, 260, 310, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2017[6] = {220, 250, 285, 340, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2018[6] = {120, 140, 160, 195, 700};")
