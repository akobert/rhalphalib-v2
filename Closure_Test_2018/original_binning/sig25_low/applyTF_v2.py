...
def drawDiagnostic(name, ifile1):
	...
	ofile = ROOT.TFile("./TF_plots.root", "RECREATE")
        ...
        ROOT.gInterpreter.Declare("Double_t widebins_2016[6] = {200, 230, 255, 290, 360, 1000};")
        ROOT.gInterpreter.Declare("Double_t widebins_2017[6] = {220, 230, 255, 290, 360, 1000};")
        ROOT.gInterpreter.Declare("Double_t widebins_2018[6] = {120, 170, 220, 300, 400, 700};")
