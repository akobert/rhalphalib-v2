...
def drawDiagnostic(name, ifile1):
	...
	ofile = ROOT.TFile("./TF_plots.root", "RECREATE")
        ...
        ROOT.gInterpreter.Declare("Double_t widebins_2016[6] = {200, 225, 245, 275, 325, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2017[6] = {220, 245, 270, 300, 350, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2018[6] = {120, 135, 150, 170, 200, 700};")
