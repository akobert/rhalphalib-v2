...
def drawDiagnostic(name, ifile1):
	...
	sig_name = "sig25_nano"
    	...
    	ptBins['2016'] = np.array([200, 230, 255, 285, 335, 700])
    	ptBins['2017'] = np.array([220, 250, 280, 320, 380, 700])
    	ptBins['2018'] = np.array([120, 150, 180, 210, 260, 700])
	...
	ofile = ROOT.TFile("./TF_plots.root", "RECREATE")
        ...
        ROOT.gInterpreter.Declare("Double_t widebins_2016[6] = {200, 230, 255, 285, 335, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2017[6] = {220, 250, 280, 320, 380, 700};")
        ROOT.gInterpreter.Declare("Double_t widebins_2018[6] = {120, 150, 180, 210, 260, 700};")
	...
	for y in years:
		if y == '2016':
			mpt_TF[y] = TH2F("mpt_TF_"+y, "pT vs. Softdrop Mass Transfer Factor", 5, widebins_2016, 40, 0, 200)
			pass_data[y] = TH2F("pass_data_"+y, "Passing Data "+y, 5, widebins_2016, 40, 0, 200)
			fail_data[y] = TH2F("fail_data_"+y, "Failing Data "+y, 5, widebins_2016, 40, 0, 200)
			pass_nres[y] = TH2F("pass_nres_"+y, "Passing Non-Resonant Background "+y, 5, widebins_2016, 40, 0, 200)
			fail_nres[y] = TH2F("fail_nres_"+y, "Failing Non-Resonant Background "+y, 5, widebins_2016, 40, 0, 200)
			pass_ttbar[y] = TH2F("pass_ttbar_"+y, "Passing TTBar "+y, 5, widebins_2016, 40, 0, 200)
			fail_ttbar[y] = TH2F("fail_ttbar_"+y, "Failing TTBar "+y, 5, widebins_2016, 40, 0, 200)
			pass_wgamma[y] = TH2F("pass_wgamma_"+y, "Passing WGamma "+y, 5, widebins_2016, 40, 0, 200)
			fail_wgamma[y] = TH2F("fail_wgamma_"+y, "Failing WGamma "+y, 5, widebins_2016, 40, 0, 200)
			pass_zgamma[y] = TH2F("pass_zgamma_"+y, "Passing ZGamma "+y, 5, widebins_2016, 40, 0, 200)
			fail_zgamma[y] = TH2F("fail_zgamma_"+y, "Failing ZGamma "+y, 5, widebins_2016, 40, 0, 200)
			pass_tbkg[y] = TH2F("pass_tbkg_"+y, "Passing Total-Background "+y, 5, widebins_2016, 40, 0, 200)
			fail_tbkg[y] = TH2F("fail_tbkg_"+y, "Failing Total-Background "+y, 5, widebins_2016, 40, 0, 200)
		if y == '2017':
			mpt_TF[y] = TH2F("mpt_TF_"+y, "pT vs. Softdrop Mass Transfer Factor", 5, widebins_2017, 40, 0, 200)
			pass_data[y] = TH2F("pass_data_"+y, "Passing Data "+y, 5, widebins_2017, 40, 0, 200)
			fail_data[y] = TH2F("fail_data_"+y, "Failing Data "+y, 5, widebins_2017, 40, 0, 200)
			pass_nres[y] = TH2F("pass_nres_"+y, "Passing Non-Resonant Background "+y, 5, widebins_2017, 40, 0, 200)
			fail_nres[y] = TH2F("fail_nres_"+y, "Failing Non-Resonant Background "+y, 5, widebins_2017, 40, 0, 200)
			pass_ttbar[y] = TH2F("pass_ttbar_"+y, "Passing TTBar "+y, 5, widebins_2017, 40, 0, 200)
			fail_ttbar[y] = TH2F("fail_ttbar_"+y, "Failing TTBar "+y, 5, widebins_2017, 40, 0, 200)
			pass_wgamma[y] = TH2F("pass_wgamma_"+y, "Passing WGamma "+y, 5, widebins_2017, 40, 0, 200)
			fail_wgamma[y] = TH2F("fail_wgamma_"+y, "Failing WGamma "+y, 5, widebins_2017, 40, 0, 200)
			pass_zgamma[y] = TH2F("pass_zgamma_"+y, "Passing ZGamma "+y, 5, widebins_2017, 40, 0, 200)
			fail_zgamma[y] = TH2F("fail_zgamma_"+y, "Failing ZGamma "+y, 5, widebins_2017, 40, 0, 200)
			pass_tbkg[y] = TH2F("pass_tbkg_"+y, "Passing Total-Background "+y, 5, widebins_2017, 40, 0, 200)
			fail_tbkg[y] = TH2F("fail_tbkg_"+y, "Failing Total-Background "+y, 5, widebins_2017, 40, 0, 200)
		if y == '2018':
			mpt_TF[y] = TH2F("mpt_TF_"+y, "pT vs. Softdrop Mass Transfer Factor", 5, widebins_2018, 40, 0, 200)
			pass_data[y] = TH2F("pass_data_"+y, "Passing Data "+y, 5, widebins_2018, 40, 0, 200)
			fail_data[y] = TH2F("fail_data_"+y, "Failing Data "+y, 5, widebins_2018, 40, 0, 200)
			pass_nres[y] = TH2F("pass_nres_"+y, "Passing Non-Resonant Background "+y, 5, widebins_2018, 40, 0, 200)
			fail_nres[y] = TH2F("fail_nres_"+y, "Failing Non-Resonant Background "+y, 5, widebins_2018, 40, 0, 200)
			pass_ttbar[y] = TH2F("pass_ttbar_"+y, "Passing TTBar "+y, 5, widebins_2018, 40, 0, 200)
			fail_ttbar[y] = TH2F("fail_ttbar_"+y, "Failing TTBar "+y, 5, widebins_2018, 40, 0, 200)
			pass_wgamma[y] = TH2F("pass_wgamma_"+y, "Passing WGamma "+y, 5, widebins_2018, 40, 0, 200)
			fail_wgamma[y] = TH2F("fail_wgamma_"+y, "Failing WGamma "+y, 5, widebins_2018, 40, 0, 200)
			pass_zgamma[y] = TH2F("pass_zgamma_"+y, "Passing ZGamma "+y, 5, widebins_2018, 40, 0, 200)
			fail_zgamma[y] = TH2F("fail_zgamma_"+y, "Failing ZGamma "+y, 5, widebins_2018, 40, 0, 200)
			pass_tbkg[y] = TH2F("pass_tbkg_"+y, "Passing Total-Background "+y, 5, widebins_2018, 40, 0, 200)
			fail_tbkg[y] = TH2F("fail_tbkg_"+y, "Failing Total-Background "+y, 5, widebins_2018, 40, 0, 200)
