...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.Sig75_p7_w = self.s1.Get("jet_pt_soft_pass_wide14_wide")
		self.Sig75_f7_w = self.s1.Get("jet_pt_soft_fail_wide14_wide")
		
		self.Sig75_p1 = self.s1.Get("pass_soft")	
		self.Sig75_f1 = self.s1.Get("fail_soft")	
		
		self.Sig75_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide14_wide_puUp")
		self.Sig75_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide14_wide_puUp")
		self.Sig75_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig75_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig75_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide14_wide_puDown")
		self.Sig75_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide14_wide_puDown")
		self.Sig75_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig75_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig75_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide14_wide_jerUp")
		self.Sig75_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide14_wide_jerUp")
		self.Sig75_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig75_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig75_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide14_wide_jerDown")
		self.Sig75_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide14_wide_jerDown")
		self.Sig75_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig75_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig75_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide14_wide_jesUp")
		self.Sig75_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide14_wide_jesUp")
		self.Sig75_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig75_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig75_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide14_wide_jesDown")
		self.Sig75_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide14_wide_jesDown")
		...
		ofile.WriteObject(self.Sig75_p7_w, "Sig75_pass_jet_pt_soft_wide14")
		ofile.WriteObject(self.Sig75_f7_w, "Sig75_fail_jet_pt_soft_wide14")
		ofile.WriteObject(self.Sig75_p1, "Sig75_pass_soft")
		ofile.WriteObject(self.Sig75_f1, "Sig75_fail_soft")
		
		ofile.WriteObject(self.Sig75_p7_w_puUp, "Sig75_pass_jet_pt_soft_wide14_puUp")
		ofile.WriteObject(self.Sig75_f7_w_puUp, "Sig75_fail_jet_pt_soft_wide14_puUp")
		ofile.WriteObject(self.Sig75_p1_puUp, "Sig75_pass_soft_puUp")
		ofile.WriteObject(self.Sig75_f1_puUp, "Sig75_fail_soft_puUp")

		ofile.WriteObject(self.Sig75_p7_w_puDown, "Sig75_pass_jet_pt_soft_wide14_puDown")
		ofile.WriteObject(self.Sig75_f7_w_puDown, "Sig75_fail_jet_pt_soft_wide14_puDown")
		...
		ofile.WriteObject(self.Sig75_p7_w_jerUp, "Sig75_pass_jet_pt_soft_wide14_jerUp")
		ofile.WriteObject(self.Sig75_f7_w_jerUp, "Sig75_fail_jet_pt_soft_wide14_jerUp")
		ofile.WriteObject(self.Sig75_p1_jerUp, "Sig75_pass_soft_jerUp")
		ofile.WriteObject(self.Sig75_f1_jerUp, "Sig75_fail_soft_jerUp")

		ofile.WriteObject(self.Sig75_p7_w_jerDown, "Sig75_pass_jet_pt_soft_wide14_jerDown")
		ofile.WriteObject(self.Sig75_f7_w_jerDown, "Sig75_fail_jet_pt_soft_wide14_jerDown")
		...
		ofile.WriteObject(self.Sig75_p7_w_jesUp, "Sig75_pass_jet_pt_soft_wide14_jesUp")
		ofile.WriteObject(self.Sig75_f7_w_jesUp, "Sig75_fail_jet_pt_soft_wide14_jesUp")
		ofile.WriteObject(self.Sig75_p1_jesUp, "Sig75_pass_soft_jesUp")
		ofile.WriteObject(self.Sig75_f1_jesUp, "Sig75_fail_soft_jesUp")

		ofile.WriteObject(self.Sig75_p7_w_jesDown, "Sig75_pass_jet_pt_soft_wide14_jesDown")
		ofile.WriteObject(self.Sig75_f7_w_jesDown, "Sig75_fail_jet_pt_soft_wide14_jesDown")
