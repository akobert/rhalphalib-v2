...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, bfile5, bfile6, bfile7, bfile8, dfile1, dfile2, sfile1, sfile2):
		...
		self.Sig150_p7_w = self.s1.Get("jet_pt_soft_pass_wide11_wide")
		self.Sig150_f7_w = self.s1.Get("jet_pt_soft_fail_wide11_wide")
		
		self.Sig150_p1 = self.s1.Get("pass_soft")	
		self.Sig150_f1 = self.s1.Get("fail_soft")	
		
		self.Sig150_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.Sig150_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.Sig150_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig150_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig150_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.Sig150_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.Sig150_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig150_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig150_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.Sig150_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.Sig150_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig150_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig150_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.Sig150_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.Sig150_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig150_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig150_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.Sig150_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.Sig150_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig150_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig150_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.Sig150_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		self.Data_APV_p7_w = self.l.Get("jet_pt_soft_pass_wide11_wide")
		self.Data_APV_f7_w = self.l.Get("jet_pt_soft_fail_wide11_wide")
		self.Data_APV_p1 = self.l.Get("pass_soft")
		self.Data_APV_f1 = self.l.Get("fail_soft")
		

		self.m = TFile(bfile5, "READ")
		self.TTBar_APV_p7_w = self.m.Get("jet_pt_soft_pass_wide11_wide")
		self.TTBar_APV_f7_w = self.m.Get("jet_pt_soft_fail_wide11_wide")
		
		self.TTBar_APV_p1 = self.m.Get("pass_soft")	
		self.TTBar_APV_f1 = self.m.Get("fail_soft")	
		
		self.TTBar_APV_p7_w_puUp = self.m.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.TTBar_APV_f7_w_puUp = self.m.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.TTBar_APV_p1_puUp = self.m.Get("pass_soft_puUp")	
		self.TTBar_APV_f1_puUp = self.m.Get("fail_soft_puUp")	
		
		self.TTBar_APV_p7_w_puDown = self.m.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.TTBar_APV_f7_w_puDown = self.m.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.TTBar_APV_p1_puDown = self.m.Get("pass_soft_puDown")	
		self.TTBar_APV_f1_puDown = self.m.Get("fail_soft_puDown")	
		
		self.TTBar_APV_p7_w_jerUp = self.m.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.TTBar_APV_f7_w_jerUp = self.m.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.TTBar_APV_p1_jerUp = self.m.Get("pass_soft_jerUp")	
		self.TTBar_APV_f1_jerUp = self.m.Get("fail_soft_jerUp")	
		
		self.TTBar_APV_p7_w_jerDown = self.m.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.TTBar_APV_f7_w_jerDown = self.m.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.TTBar_APV_p1_jerDown = self.m.Get("pass_soft_jerDown")	
		self.TTBar_APV_f1_jerDown = self.m.Get("fail_soft_jerDown")	
		
		self.TTBar_APV_p7_w_jesUp = self.m.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.TTBar_APV_f7_w_jesUp = self.m.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.TTBar_APV_p1_jesUp = self.m.Get("pass_soft_jesUp")	
		self.TTBar_APV_f1_jesUp = self.m.Get("fail_soft_jesUp")	
		
		self.TTBar_APV_p7_w_jesDown = self.m.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.TTBar_APV_f7_w_jesDown = self.m.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		self.WGamma_APV_p7_w = self.n.Get("jet_pt_soft_pass_wide11_wide")
		self.WGamma_APV_f7_w = self.n.Get("jet_pt_soft_fail_wide11_wide")
		
		self.WGamma_APV_p1 = self.n.Get("pass_soft")	
		self.WGamma_APV_f1 = self.n.Get("fail_soft")	
		
		self.WGamma_APV_p7_w_puUp = self.n.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.WGamma_APV_f7_w_puUp = self.n.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.WGamma_APV_p1_puUp = self.n.Get("pass_soft_puUp")	
		self.WGamma_APV_f1_puUp = self.n.Get("fail_soft_puUp")	
		
		self.WGamma_APV_p7_w_puDown = self.n.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.WGamma_APV_f7_w_puDown = self.n.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.WGamma_APV_p1_puDown = self.n.Get("pass_soft_puDown")	
		self.WGamma_APV_f1_puDown = self.n.Get("fail_soft_puDown")	
		
		self.WGamma_APV_p7_w_jerUp = self.n.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.WGamma_APV_f7_w_jerUp = self.n.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.WGamma_APV_p1_jerUp = self.n.Get("pass_soft_jerUp")	
		self.WGamma_APV_f1_jerUp = self.n.Get("fail_soft_jerUp")	
		
		self.WGamma_APV_p7_w_jerDown = self.n.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.WGamma_APV_f7_w_jerDown = self.n.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.WGamma_APV_p1_jerDown = self.n.Get("pass_soft_jerDown")	
		self.WGamma_APV_f1_jerDown = self.n.Get("fail_soft_jerDown")	
		
		self.WGamma_APV_p7_w_jesUp = self.n.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.WGamma_APV_f7_w_jesUp = self.n.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.WGamma_APV_p1_jesUp = self.n.Get("pass_soft_jesUp")	
		self.WGamma_APV_f1_jesUp = self.n.Get("fail_soft_jesUp")	
		
		self.WGamma_APV_p7_w_jesDown = self.n.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.WGamma_APV_f7_w_jesDown = self.n.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		self.ZGamma_APV_p7_w = self.o.Get("jet_pt_soft_pass_wide11_wide")
		self.ZGamma_APV_f7_w = self.o.Get("jet_pt_soft_fail_wide11_wide")
		
		self.ZGamma_APV_p1 = self.o.Get("pass_soft")	
		self.ZGamma_APV_f1 = self.o.Get("fail_soft")	
		
		self.ZGamma_APV_p7_w_puUp = self.o.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.ZGamma_APV_f7_w_puUp = self.o.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.ZGamma_APV_p1_puUp = self.o.Get("pass_soft_puUp")	
		self.ZGamma_APV_f1_puUp = self.o.Get("fail_soft_puUp")	
		
		self.ZGamma_APV_p7_w_puDown = self.o.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.ZGamma_APV_f7_w_puDown = self.o.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.ZGamma_APV_p1_puDown = self.o.Get("pass_soft_puDown")	
		self.ZGamma_APV_f1_puDown = self.o.Get("fail_soft_puDown")	
		
		self.ZGamma_APV_p7_w_jerUp = self.o.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.ZGamma_APV_f7_w_jerUp = self.o.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.ZGamma_APV_p1_jerUp = self.o.Get("pass_soft_jerUp")	
		self.ZGamma_APV_f1_jerUp = self.o.Get("fail_soft_jerUp")	
		
		self.ZGamma_APV_p7_w_jerDown = self.o.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.ZGamma_APV_f7_w_jerDown = self.o.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.ZGamma_APV_p1_jerDown = self.o.Get("pass_soft_jerDown")	
		self.ZGamma_APV_f1_jerDown = self.o.Get("fail_soft_jerDown")	
		
		self.ZGamma_APV_p7_w_jesUp = self.o.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.ZGamma_APV_f7_w_jesUp = self.o.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.ZGamma_APV_p1_jesUp = self.o.Get("pass_soft_jesUp")	
		self.ZGamma_APV_f1_jesUp = self.o.Get("fail_soft_jesUp")	
		
		self.ZGamma_APV_p7_w_jesDown = self.o.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.ZGamma_APV_f7_w_jesDown = self.o.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		self.GJ_APV_p7_w = self.p.Get("jet_pt_soft_pass_wide11_wide")
		self.GJ_APV_f7_w = self.p.Get("jet_pt_soft_fail_wide11_wide")
		
		self.GJ_APV_p1 = self.p.Get("pass_soft")	
		self.GJ_APV_f1 = self.p.Get("fail_soft")	
		
		self.GJ_APV_p7_w_puUp = self.p.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.GJ_APV_f7_w_puUp = self.p.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.GJ_APV_p1_puUp = self.p.Get("pass_soft_puUp")	
		self.GJ_APV_f1_puUp = self.p.Get("fail_soft_puUp")	
		
		self.GJ_APV_p7_w_puDown = self.p.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.GJ_APV_f7_w_puDown = self.p.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.GJ_APV_p1_puDown = self.p.Get("pass_soft_puDown")	
		self.GJ_APV_f1_puDown = self.p.Get("fail_soft_puDown")	
		
		self.GJ_APV_p7_w_jerUp = self.p.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.GJ_APV_f7_w_jerUp = self.p.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.GJ_APV_p1_jerUp = self.p.Get("pass_soft_jerUp")	
		self.GJ_APV_f1_jerUp = self.p.Get("fail_soft_jerUp")	
		
		self.GJ_APV_p7_w_jerDown = self.p.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.GJ_APV_f7_w_jerDown = self.p.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.GJ_APV_p1_jerDown = self.p.Get("pass_soft_jerDown")	
		self.GJ_APV_f1_jerDown = self.p.Get("fail_soft_jerDown")	
		
		self.GJ_APV_p7_w_jesUp = self.p.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.GJ_APV_f7_w_jesUp = self.p.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.GJ_APV_p1_jesUp = self.p.Get("pass_soft_jesUp")	
		self.GJ_APV_f1_jesUp = self.p.Get("fail_soft_jesUp")	
		
		self.GJ_APV_p7_w_jesDown = self.p.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.GJ_APV_f7_w_jesDown = self.p.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		self.Sig150_APV_p7_w = self.s2.Get("jet_pt_soft_pass_wide11_wide")
		self.Sig150_APV_f7_w = self.s2.Get("jet_pt_soft_fail_wide11_wide")
		
		self.Sig150_APV_p1 = self.s2.Get("pass_soft")	
		self.Sig150_APV_f1 = self.s2.Get("fail_soft")	
		
		self.Sig150_APV_p7_w_puUp = self.s2.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.Sig150_APV_f7_w_puUp = self.s2.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.Sig150_APV_p1_puUp = self.s2.Get("pass_soft_puUp")	
		self.Sig150_APV_f1_puUp = self.s2.Get("fail_soft_puUp")	
		
		self.Sig150_APV_p7_w_puDown = self.s2.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.Sig150_APV_f7_w_puDown = self.s2.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.Sig150_APV_p1_puDown = self.s2.Get("pass_soft_puDown")	
		self.Sig150_APV_f1_puDown = self.s2.Get("fail_soft_puDown")	
		
		self.Sig150_APV_p7_w_jerUp = self.s2.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.Sig150_APV_f7_w_jerUp = self.s2.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.Sig150_APV_p1_jerUp = self.s2.Get("pass_soft_jerUp")	
		self.Sig150_APV_f1_jerUp = self.s2.Get("fail_soft_jerUp")	
		
		self.Sig150_APV_p7_w_jerDown = self.s2.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.Sig150_APV_f7_w_jerDown = self.s2.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.Sig150_APV_p1_jerDown = self.s2.Get("pass_soft_jerDown")	
		self.Sig150_APV_f1_jerDown = self.s2.Get("fail_soft_jerDown")	
		
		self.Sig150_APV_p7_w_jesUp = self.s2.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.Sig150_APV_f7_w_jesUp = self.s2.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.Sig150_APV_p1_jesUp = self.s2.Get("pass_soft_jesUp")	
		self.Sig150_APV_f1_jesUp = self.s2.Get("fail_soft_jesUp")	
		
		self.Sig150_APV_p7_w_jesDown = self.s2.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.Sig150_APV_f7_w_jesDown = self.s2.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		ofile.WriteObject(self.Sig150_p7_w, "Sig150_pass_jet_pt_soft_wide11")
		ofile.WriteObject(self.Sig150_f7_w, "Sig150_fail_jet_pt_soft_wide11")
		ofile.WriteObject(self.Sig150_p1, "Sig150_pass_soft")
		ofile.WriteObject(self.Sig150_f1, "Sig150_fail_soft")
		
		ofile.WriteObject(self.Sig150_p7_w_puUp, "Sig150_pass_jet_pt_soft_wide11_puUp")
		ofile.WriteObject(self.Sig150_f7_w_puUp, "Sig150_fail_jet_pt_soft_wide11_puUp")
		ofile.WriteObject(self.Sig150_p1_puUp, "Sig150_pass_soft_puUp")
		ofile.WriteObject(self.Sig150_f1_puUp, "Sig150_fail_soft_puUp")

		ofile.WriteObject(self.Sig150_p7_w_puDown, "Sig150_pass_jet_pt_soft_wide11_puDown")
		ofile.WriteObject(self.Sig150_f7_w_puDown, "Sig150_fail_jet_pt_soft_wide11_puDown")
		...
		ofile.WriteObject(self.Sig150_p7_w_jerUp, "Sig150_pass_jet_pt_soft_wide11_jerUp")
		ofile.WriteObject(self.Sig150_f7_w_jerUp, "Sig150_fail_jet_pt_soft_wide11_jerUp")
		...
		ofile.WriteObject(self.Sig150_p7_w_jerDown, "Sig150_pass_jet_pt_soft_wide11_jerDown")
		ofile.WriteObject(self.Sig150_f7_w_jerDown, "Sig150_fail_jet_pt_soft_wide11_jerDown")
		...
		ofile.WriteObject(self.Sig150_p7_w_jesUp, "Sig150_pass_jet_pt_soft_wide11_jesUp")
		ofile.WriteObject(self.Sig150_f7_w_jesUp, "Sig150_fail_jet_pt_soft_wide11_jesUp")
		...
		ofile.WriteObject(self.Sig150_p7_w_jesDown, "Sig150_pass_jet_pt_soft_wide11_jesDown")
		ofile.WriteObject(self.Sig150_f7_w_jesDown, "Sig150_fail_jet_pt_soft_wide11_jesDown")
