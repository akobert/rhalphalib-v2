...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([200, 240, 275, 330, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins11[6] = {200, 240, 275, 330, 700};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins11, 40, 0, 2000)
