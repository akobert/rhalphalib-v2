...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 220, 260, 300, 360, 700, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins11[9] = {0, 220, 260, 300, 360, 700, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 7, widebins11, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([220, 260, 300, 360, 700])
    npt = len(ptbins) - 1
