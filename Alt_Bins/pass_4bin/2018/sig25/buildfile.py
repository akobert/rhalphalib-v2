...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.Sig25_p7_w = self.s1.Get("jet_pt_soft_pass_wide15_wide")
		self.Sig25_f7_w = self.s1.Get("jet_pt_soft_fail_wide15_wide")
		
		self.Sig25_p1 = self.s1.Get("pass_soft")	
		self.Sig25_f1 = self.s1.Get("fail_soft")	
		
		self.Sig25_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide15_wide_puUp")
		self.Sig25_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide15_wide_puUp")
		self.Sig25_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig25_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig25_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide15_wide_puDown")
		self.Sig25_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide15_wide_puDown")
		self.Sig25_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig25_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig25_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide15_wide_jerUp")
		self.Sig25_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide15_wide_jerUp")
		self.Sig25_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig25_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig25_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide15_wide_jerDown")
		self.Sig25_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide15_wide_jerDown")
		self.Sig25_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig25_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig25_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide15_wide_jesUp")
		self.Sig25_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide15_wide_jesUp")
		self.Sig25_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig25_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig25_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide15_wide_jesDown")
		self.Sig25_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide15_wide_jesDown")
		...
		ofile.WriteObject(self.Sig25_p7_w, "Sig25_pass_jet_pt_soft_wide15")
		ofile.WriteObject(self.Sig25_f7_w, "Sig25_fail_jet_pt_soft_wide15")
		ofile.WriteObject(self.Sig25_p1, "Sig25_pass_soft")
		ofile.WriteObject(self.Sig25_f1, "Sig25_fail_soft")
		
		ofile.WriteObject(self.Sig25_p7_w_puUp, "Sig25_pass_jet_pt_soft_wide15_puUp")
		ofile.WriteObject(self.Sig25_f7_w_puUp, "Sig25_fail_jet_pt_soft_wide15_puUp")
		ofile.WriteObject(self.Sig25_p1_puUp, "Sig25_pass_soft_puUp")
		ofile.WriteObject(self.Sig25_f1_puUp, "Sig25_fail_soft_puUp")

		ofile.WriteObject(self.Sig25_p7_w_puDown, "Sig25_pass_jet_pt_soft_wide15_puDown")
		ofile.WriteObject(self.Sig25_f7_w_puDown, "Sig25_fail_jet_pt_soft_wide15_puDown")
		...
		ofile.WriteObject(self.Sig25_p7_w_jerUp, "Sig25_pass_jet_pt_soft_wide15_jerUp")
		ofile.WriteObject(self.Sig25_f7_w_jerUp, "Sig25_fail_jet_pt_soft_wide15_jerUp")
		ofile.WriteObject(self.Sig25_p1_jerUp, "Sig25_pass_soft_jerUp")
		ofile.WriteObject(self.Sig25_f1_jerUp, "Sig25_fail_soft_jerUp")

		ofile.WriteObject(self.Sig25_p7_w_jerDown, "Sig25_pass_jet_pt_soft_wide15_jerDown")
		ofile.WriteObject(self.Sig25_f7_w_jerDown, "Sig25_fail_jet_pt_soft_wide15_jerDown")
		...
		ofile.WriteObject(self.Sig25_p7_w_jesUp, "Sig25_pass_jet_pt_soft_wide15_jesUp")
		ofile.WriteObject(self.Sig25_f7_w_jesUp, "Sig25_fail_jet_pt_soft_wide15_jesUp")
		ofile.WriteObject(self.Sig25_p1_jesUp, "Sig25_pass_soft_jesUp")
		ofile.WriteObject(self.Sig25_f1_jesUp, "Sig25_fail_soft_jesUp")

		ofile.WriteObject(self.Sig25_p7_w_jesDown, "Sig25_pass_jet_pt_soft_wide15_jesDown")
		ofile.WriteObject(self.Sig25_f7_w_jesDown, "Sig25_fail_jet_pt_soft_wide15_jesDown")
