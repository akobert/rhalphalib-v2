...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 200, 230, 255, 285, 335, 700, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins10[9] = {0, 200, 230, 255, 285, 335, 700, 2000};")
...
def test_rhalphabet(tmpdir,
    ...
    tf_MCtempl = rl.BasisPoly('CMS_EXO24027_tf_MCtempl', (3, 3), ['pt', 'rho'], basis='Bernstein', init_params=initial_vals, limits=(-100, 100))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BasisPoly('CMS_EXO24027_tf_dataResidual_2016', (3, 3), ['pt', 'rho'] ,basis='Bernstein', limits=(-100, 100))
