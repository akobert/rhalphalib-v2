...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, bfile5, bfile6, bfile7, bfile8, dfile1, dfile2, sfile1, sfile2):
		...
		self.Sig20_p7_w = self.s1.Get("jet_pt_soft_pass_wide10_wide")
		self.Sig20_f7_w = self.s1.Get("jet_pt_soft_fail_wide10_wide")
		
		self.Sig20_p1 = self.s1.Get("pass_soft")	
		self.Sig20_f1 = self.s1.Get("fail_soft")	
		
		self.Sig20_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide10_wide_puUp")
		self.Sig20_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide10_wide_puUp")
		self.Sig20_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig20_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig20_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide10_wide_puDown")
		self.Sig20_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide10_wide_puDown")
		self.Sig20_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig20_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig20_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide10_wide_jerUp")
		self.Sig20_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide10_wide_jerUp")
		self.Sig20_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig20_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig20_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide10_wide_jerDown")
		self.Sig20_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide10_wide_jerDown")
		self.Sig20_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig20_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig20_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide10_wide_jesUp")
		self.Sig20_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide10_wide_jesUp")
		self.Sig20_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig20_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig20_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide10_wide_jesDown")
		self.Sig20_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide10_wide_jesDown")
		...
		self.Sig20_APV_p7_w = self.s2.Get("jet_pt_soft_pass_wide10_wide")
		self.Sig20_APV_f7_w = self.s2.Get("jet_pt_soft_fail_wide10_wide")
		
		self.Sig20_APV_p1 = self.s2.Get("pass_soft")	
		self.Sig20_APV_f1 = self.s2.Get("fail_soft")	
		
		self.Sig20_APV_p7_w_puUp = self.s2.Get("jet_pt_soft_pass_wide10_wide_puUp")
		self.Sig20_APV_f7_w_puUp = self.s2.Get("jet_pt_soft_fail_wide10_wide_puUp")
		self.Sig20_APV_p1_puUp = self.s2.Get("pass_soft_puUp")	
		self.Sig20_APV_f1_puUp = self.s2.Get("fail_soft_puUp")	
		
		self.Sig20_APV_p7_w_puDown = self.s2.Get("jet_pt_soft_pass_wide10_wide_puDown")
		self.Sig20_APV_f7_w_puDown = self.s2.Get("jet_pt_soft_fail_wide10_wide_puDown")
		self.Sig20_APV_p1_puDown = self.s2.Get("pass_soft_puDown")	
		self.Sig20_APV_f1_puDown = self.s2.Get("fail_soft_puDown")	
		
		self.Sig20_APV_p7_w_jerUp = self.s2.Get("jet_pt_soft_pass_wide10_wide_jerUp")
		self.Sig20_APV_f7_w_jerUp = self.s2.Get("jet_pt_soft_fail_wide10_wide_jerUp")
		self.Sig20_APV_p1_jerUp = self.s2.Get("pass_soft_jerUp")	
		self.Sig20_APV_f1_jerUp = self.s2.Get("fail_soft_jerUp")	
		
		self.Sig20_APV_p7_w_jerDown = self.s2.Get("jet_pt_soft_pass_wide10_wide_jerDown")
		self.Sig20_APV_f7_w_jerDown = self.s2.Get("jet_pt_soft_fail_wide10_wide_jerDown")
		self.Sig20_APV_p1_jerDown = self.s2.Get("pass_soft_jerDown")	
		self.Sig20_APV_f1_jerDown = self.s2.Get("fail_soft_jerDown")	
		
		self.Sig20_APV_p7_w_jesUp = self.s2.Get("jet_pt_soft_pass_wide10_wide_jesUp")
		self.Sig20_APV_f7_w_jesUp = self.s2.Get("jet_pt_soft_fail_wide10_wide_jesUp")
		self.Sig20_APV_p1_jesUp = self.s2.Get("pass_soft_jesUp")	
		self.Sig20_APV_f1_jesUp = self.s2.Get("fail_soft_jesUp")	
		
		self.Sig20_APV_p7_w_jesDown = self.s2.Get("jet_pt_soft_pass_wide10_wide_jesDown")
		self.Sig20_APV_f7_w_jesDown = self.s2.Get("jet_pt_soft_fail_wide10_wide_jesDown")
		...
		ofile.WriteObject(self.Sig20_p7_w, "Sig20_pass_jet_pt_soft_wide10")
		ofile.WriteObject(self.Sig20_f7_w, "Sig20_fail_jet_pt_soft_wide10")
		ofile.WriteObject(self.Sig20_p1, "Sig20_pass_soft")
		ofile.WriteObject(self.Sig20_f1, "Sig20_fail_soft")
		
		ofile.WriteObject(self.Sig20_p7_w_puUp, "Sig20_pass_jet_pt_soft_wide10_puUp")
		ofile.WriteObject(self.Sig20_f7_w_puUp, "Sig20_fail_jet_pt_soft_wide10_puUp")
		ofile.WriteObject(self.Sig20_p1_puUp, "Sig20_pass_soft_puUp")
		ofile.WriteObject(self.Sig20_f1_puUp, "Sig20_fail_soft_puUp")

		ofile.WriteObject(self.Sig20_p7_w_puDown, "Sig20_pass_jet_pt_soft_wide10_puDown")
		ofile.WriteObject(self.Sig20_f7_w_puDown, "Sig20_fail_jet_pt_soft_wide10_puDown")
		...
		ofile.WriteObject(self.Sig20_p7_w_jerUp, "Sig20_pass_jet_pt_soft_wide10_jerUp")
		ofile.WriteObject(self.Sig20_f7_w_jerUp, "Sig20_fail_jet_pt_soft_wide10_jerUp")
		ofile.WriteObject(self.Sig20_p1_jerUp, "Sig20_pass_soft_jerUp")
		ofile.WriteObject(self.Sig20_f1_jerUp, "Sig20_fail_soft_jerUp")

		ofile.WriteObject(self.Sig20_p7_w_jerDown, "Sig20_pass_jet_pt_soft_wide10_jerDown")
		ofile.WriteObject(self.Sig20_f7_w_jerDown, "Sig20_fail_jet_pt_soft_wide10_jerDown")
		...
		ofile.WriteObject(self.Sig20_p7_w_jesUp, "Sig20_pass_jet_pt_soft_wide10_jesUp")
		ofile.WriteObject(self.Sig20_f7_w_jesUp, "Sig20_fail_jet_pt_soft_wide10_jesUp")
		ofile.WriteObject(self.Sig20_p1_jesUp, "Sig20_pass_soft_jesUp")
		ofile.WriteObject(self.Sig20_f1_jesUp, "Sig20_fail_soft_jesUp")

		ofile.WriteObject(self.Sig20_p7_w_jesDown, "Sig20_pass_jet_pt_soft_wide10_jesDown")
		ofile.WriteObject(self.Sig20_f7_w_jesDown, "Sig20_fail_jet_pt_soft_wide10_jesDown")
