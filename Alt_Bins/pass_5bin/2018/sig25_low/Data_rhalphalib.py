...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([120, 150, 180, 210, 260, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins14[6] = {120, 150, 180, 210, 260, 700};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins14, 40, 0, 2000)
