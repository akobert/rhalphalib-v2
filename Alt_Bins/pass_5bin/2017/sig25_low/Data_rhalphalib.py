...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([220, 250, 280, 320, 380, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins10[6] = {220, 250, 280, 320, 380, 700};")
...
#	print(mpt[i][2])
    ...
    cb.set_label("Ratio")
    fig.savefig("MCTF_msdpt_2017_sig25v5.png",bbox="tight")
    plt.clf()
