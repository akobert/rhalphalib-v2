...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 220, 245, 270, 300, 350, 700, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins8[9] = {0, 220, 245, 270, 300, 350, 700, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 7, widebins8, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([220, 245, 270, 300, 350, 700])
    npt = len(ptbins) - 1
