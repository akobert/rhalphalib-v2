...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([200, 225, 245, 275, 325, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins8[6] = {200, 225, 245, 275, 325, 700};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins8, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([200, 225, 245, 275, 325, 700])
    npt = len(ptbins) - 1
