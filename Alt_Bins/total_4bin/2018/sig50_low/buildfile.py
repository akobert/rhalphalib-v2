...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.Sig50_p7_w = self.s1.Get("jet_pt_soft_pass_wide13_wide")
		self.Sig50_f7_w = self.s1.Get("jet_pt_soft_fail_wide13_wide")
		
		self.Sig50_p1 = self.s1.Get("pass_soft")	
		self.Sig50_f1 = self.s1.Get("fail_soft")	
		
		self.Sig50_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_puUp")
		self.Sig50_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_puUp")
		self.Sig50_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig50_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig50_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_puDown")
		self.Sig50_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_puDown")
		self.Sig50_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig50_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig50_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_jerUp")
		self.Sig50_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_jerUp")
		self.Sig50_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig50_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig50_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_jerDown")
		self.Sig50_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_jerDown")
		self.Sig50_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig50_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig50_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_jesUp")
		self.Sig50_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_jesUp")
		self.Sig50_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig50_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig50_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_jesDown")
		self.Sig50_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_jesDown")
		...
		ofile.WriteObject(self.Sig50_p7_w, "Sig50_pass_jet_pt_soft_wide13")
		ofile.WriteObject(self.Sig50_f7_w, "Sig50_fail_jet_pt_soft_wide13")
		ofile.WriteObject(self.Sig50_p1, "Sig50_pass_soft")
		ofile.WriteObject(self.Sig50_f1, "Sig50_fail_soft")
		
		ofile.WriteObject(self.Sig50_p7_w_puUp, "Sig50_pass_jet_pt_soft_wide13_puUp")
		ofile.WriteObject(self.Sig50_f7_w_puUp, "Sig50_fail_jet_pt_soft_wide13_puUp")
		ofile.WriteObject(self.Sig50_p1_puUp, "Sig50_pass_soft_puUp")
		ofile.WriteObject(self.Sig50_f1_puUp, "Sig50_fail_soft_puUp")

		ofile.WriteObject(self.Sig50_p7_w_puDown, "Sig50_pass_jet_pt_soft_wide13_puDown")
		ofile.WriteObject(self.Sig50_f7_w_puDown, "Sig50_fail_jet_pt_soft_wide13_puDown")
		...
		ofile.WriteObject(self.Sig50_p7_w_jerUp, "Sig50_pass_jet_pt_soft_wide13_jerUp")
		ofile.WriteObject(self.Sig50_f7_w_jerUp, "Sig50_fail_jet_pt_soft_wide13_jerUp")
		ofile.WriteObject(self.Sig50_p1_jerUp, "Sig50_pass_soft_jerUp")
		ofile.WriteObject(self.Sig50_f1_jerUp, "Sig50_fail_soft_jerUp")

		ofile.WriteObject(self.Sig50_p7_w_jerDown, "Sig50_pass_jet_pt_soft_wide13_jerDown")
		ofile.WriteObject(self.Sig50_f7_w_jerDown, "Sig50_fail_jet_pt_soft_wide13_jerDown")
		...
		ofile.WriteObject(self.Sig50_p7_w_jesUp, "Sig50_pass_jet_pt_soft_wide13_jesUp")
		ofile.WriteObject(self.Sig50_f7_w_jesUp, "Sig50_fail_jet_pt_soft_wide13_jesUp")
		ofile.WriteObject(self.Sig50_p1_jesUp, "Sig50_pass_soft_jesUp")
		ofile.WriteObject(self.Sig50_f1_jesUp, "Sig50_fail_soft_jesUp")

		ofile.WriteObject(self.Sig50_p7_w_jesDown, "Sig50_pass_jet_pt_soft_wide13_jesDown")
		ofile.WriteObject(self.Sig50_f7_w_jesDown, "Sig50_fail_jet_pt_soft_wide13_jesDown")
