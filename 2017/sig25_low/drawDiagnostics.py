...
def drawDiagnostic(name, ifile1):
	gROOT.SetBatch(True)
	Sigs = [["/home/akobert/CMSSW_11_1_0_pre7/src/RData/2017/NanoTool_UL_btag_percentage_barrel/M25_UL_nano_10_2017_merged.root"], "4.148 * 13290.0/495785.0", "", "sig25_nano", "25 GeV Signal", "7639.0"]
	sig_name = "sig25_nano"
...
#					print(cSIG.GetNbinsX())
					...
					cDATA = convertAsymGraph(cDATA, cWG, "data"+P)
					Hvec = []
					if(a != 0):
						...
						for i in [cDATA, cTBKG, cSIG, cWG, cZG, cNRES]:
							i.Scale(5.0)
							Hvec.append(convertBinNHist(i, refH, i.GetName()+"new"+P))

						if P == "prefit" and pf == "fail":
							pre_fail_data_total.Add(Hvec[0])
							pre_fail_tbkg_total.Add(Hvec[1])
							pre_fail_tsig_total.Add(Hvec[2])
							pre_fail_wgamma_total.Add(Hvec[3])
							pre_fail_zgamma_total.Add(Hvec[4])
							pre_fail_nres_total.Add(Hvec[5])
							
						elif P == "prefit" and pf == "pass":
							pre_pass_data_total.Add(Hvec[0])
							pre_pass_tbkg_total.Add(Hvec[1])
							pre_pass_tsig_total.Add(Hvec[2])
							pre_pass_wgamma_total.Add(Hvec[3])
							pre_pass_zgamma_total.Add(Hvec[4])
							pre_pass_nres_total.Add(Hvec[5])
						
						elif P == "fit_b" and pf == "fail":
							b_fail_data_total.Add(Hvec[0])
							b_fail_tbkg_total.Add(Hvec[1])
							b_fail_tsig_total.Add(Hvec[2])
							b_fail_wgamma_total.Add(Hvec[3])
							b_fail_zgamma_total.Add(Hvec[4])
							b_fail_nres_total.Add(Hvec[5])
						
						elif P == "fit_b" and pf == "pass":
							b_pass_data_total.Add(Hvec[0])
							b_pass_tbkg_total.Add(Hvec[1])
							b_pass_tsig_total.Add(Hvec[2])
							b_pass_wgamma_total.Add(Hvec[3])
							b_pass_zgamma_total.Add(Hvec[4])
							b_pass_nres_total.Add(Hvec[5])
      ...
      #                                  if P == "fit_b":
       #                                         print("fit_b Test sqrt: "+str(math.sqrt(bkg.GetBinContent(3))))
        #                                        print("fit_b Test Error: "+str(bkg.GetBinError(3)))
					...
					if(a !=0): L.AddEntry(ttbar, "t#bar{t} component", "L")
