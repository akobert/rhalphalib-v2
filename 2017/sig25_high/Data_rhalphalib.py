...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0,220, 230, 255, 290, 360, 1000,700,900,1200,1500,2000])
...
#    msdbins = np.linspace(0, 50, 11)
    ...
    tf_MCtempl = rl.BernsteinPoly('tf_MCtempl', (4, 4), ['pt', 'rho'], init_params=initial_vals, limits=(-100, 100))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BernsteinPoly('tf_dataResidual', (4, 4), ['pt', 'rho'], limits=(-100, 100))
