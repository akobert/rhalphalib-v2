...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.sig1_p7_w = self.s1.Get("jet_pt_soft_pass_wide6_wide")
		self.sig1_f7_w = self.s1.Get("jet_pt_soft_fail_wide6_wide")
		...
		ofile.WriteObject(self.sig1_p7_w, "Sig25_pass_jet_pt_soft_wide6")
		ofile.WriteObject(self.sig1_f7_w, "Sig25_fail_jet_pt_soft_wide6")
