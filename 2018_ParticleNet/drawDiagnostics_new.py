...
def drawDiagnostic(name, ifile1, mass):
	...
	#LUMI['Run2'] = 7.779 #Temporary luminosity with 10% of 2016+2017
...
#	if P != "fit_b":  L.AddEntry(b_pass_tsig25_total, b_pass_tsig25_total_name, "F")
	...
	p12.cd() # top
	ROOT.gPad.SetTicks(1,1)
	b_pass_tbkg_total.SetTitle("2018 (10%) Background Only Fit Plot All Bins")
...
#	if P != "fit_b":  L.AddEntry(s_pass_tsig25_total, s_pass_tsig25_total_name, "F")
	...
	p12.cd() # top
	ROOT.gPad.SetTicks(1,1)
	s_pass_tbkg_total.SetTitle("2018 (10%) Multiple Signal Background Fit Plot With Signal All Bins")
