...
def drawDiagnostic(name, ifile1):
	...
	for y in years:
		if y == '2016':
			mpt_TF[y] = TH2F("mpt_TF_"+y, y+" TF Plotted in Jet pT vs. Softdrop Mass", 4, widebins_2016, 40, 0, 200)
		...
		if y == '2017':
			mpt_TF[y] = TH2F("mpt_TF_"+y, y+" TF Plotted in Jet pT vs. Softdrop Mass", 4, widebins_2017, 40, 0, 200)
		...
		if y == '2018':
			mpt_TF[y] = TH2F("mpt_TF_"+y, y+" TF Plotted in Jet pT vs. Softdrop Mass", 4, widebins_2018, 40, 0, 200)
...
#                                        GoodPlotFormat(nonRes,"dashed", ROOT.kCyan, 1)
	...
	#						print("xbin: "+str(a+1)+" ybin: "+str(i)+" pass_nres[y] content: "+str(Hvec[5].GetBinContent(i)))
		...
		mpt_TF[y].SetTitle(y+" TF Plotted in Jet pT vs. Softdrop Mass") 
