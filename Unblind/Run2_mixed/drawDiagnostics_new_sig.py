      ...
      # 	                                 if P == "fit_b":
       #	                                         print("fit_b Test sqrt: "+str(math.sqrt(bkg.GetBinContent(3))))
        	#                                        print("fit_b Test Error: "+str(bkg.GetBinError(3)))
						...
						if P != "prefit":  L.AddEntry(sig10, "10 GeV Signal", "F")
						if P != "prefit":  L.AddEntry(sig25, "25 GeV Signal", "F")
						if P != "prefit":  L.AddEntry(sig50, "50 GeV Signal", "F")
						if P != "prefit":  L.AddEntry(sig75, "75 GeV Signal", "F")
						C = ROOT.TCanvas()
						C.cd()
						...
						if P == "fit_s" and pf == "pass":
							bkg.SetTitle(str(y)+" Passing Softdrop in "+str(ptBins[y][a])+"-"+str(ptBins[y][a+1])+" pT Bin")
						if P == "fit_s" and pf == "fail":
							bkg.SetTitle(str(y)+" Failing Softdrop in "+str(ptBins[y][a])+"-"+str(ptBins[y][a+1])+" pT Bin")
						bkg.Draw("hist")
						ttbar.Draw("histsame")
	                                        WG.Draw("histsame")
	                                        ZG.Draw("histsame")
						nonRes.Draw("histsame")
						if P != "prefit": sig10.Draw("histsame")
						if P != "prefit": sig25.Draw("histsame")
						if P != "prefit": sig50.Draw("histsame")
						if P != "prefit": sig75.Draw("histsame")
						...
						l2.Draw("same")
						p22.RedrawAxis()
	#					C.Print("results_sig/"+NAME+"/"+savename+"_"+pf+str(a)+"_v5.root")
						C.Print("results_sig/"+NAME+"/"+y+"_"+savename+"_"+pf+str(a)+"_"+str(name)+".png")
						p12.cd()
						gPad.SetLogy()
						p12.Draw()
						C.Print("results_sig/"+NAME+"/"+y+"_"+savename+"_"+pf+str(a)+"_"+str(name)+"_logy.png")
						if pf == "pass" and P == "fit_b":
...
#		if P != "fit_b":  L.AddEntry(year_summary[y]['sig25'], year_summary[y]['sig25']_name, "F")
	...
	#	pTbin(ROOT.gPad, "Full")
		...
		l2.Draw("same")
		p22.RedrawAxis()
		C.Print("results_sig/multiSig_pass_"+y+"_"+str(name)+".png")
		p12.cd()
		gPad.SetLogy()
		p12.Draw()
		C.Print("results_sig/multiSig_pass_"+y+"_"+str(name)+"_logy.png")
...
#	pTbin(ROOT.gPad, "Full")
	...
	l2.Draw("same")
	p22.RedrawAxis()
	C.Print("results_sig/fit_b_pass_allbins_"+str(name)+".png")
	p12.cd()
	gPad.SetLogy()
	p12.Draw()
	C.Print("results_sig/fit_b_pass_allbins_"+str(name)+"_logy.png")
...
#	pTbin(ROOT.gPad, "Full")
	...
	l2.Draw("same")
	p22.RedrawAxis()
	C.Print("results_sig/multiSig_pass_allbins_"+str(name)+".png")
	p12.cd()
	gPad.SetLogy()
	p12.Draw()
	C.Print("results_sig/multiSig_pass_allbins_"+str(name)+"_logy.png")
