...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, bfile5, bfile6, bfile7, bfile8, dfile1, dfile2, sfile1):
		...
		self.Sig60_p7_w = self.s1.Get("jet_pt_soft_pass_wide11_wide")
		self.Sig60_f7_w = self.s1.Get("jet_pt_soft_fail_wide11_wide")
		
		self.Sig60_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.Sig60_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_puUp")
		
		self.Sig60_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.Sig60_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_puDown")
		
		self.Sig60_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.Sig60_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		
		self.Sig60_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.Sig60_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		
		self.Sig60_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.Sig60_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		
		self.Sig60_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.Sig60_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		ofile.WriteObject(self.Sig60_p7_w, "Sig60_pass_jet_pt_soft_wide11")
		ofile.WriteObject(self.Sig60_f7_w, "Sig60_fail_jet_pt_soft_wide11")
		
		ofile.WriteObject(self.Sig60_p7_w_puUp, "Sig60_pass_jet_pt_soft_wide11_puUp")
		ofile.WriteObject(self.Sig60_f7_w_puUp, "Sig60_fail_jet_pt_soft_wide11_puUp")

		ofile.WriteObject(self.Sig60_p7_w_puDown, "Sig60_pass_jet_pt_soft_wide11_puDown")
		ofile.WriteObject(self.Sig60_f7_w_puDown, "Sig60_fail_jet_pt_soft_wide11_puDown")
		
		ofile.WriteObject(self.Sig60_p7_w_jerUp, "Sig60_pass_jet_pt_soft_wide11_jerUp")
		ofile.WriteObject(self.Sig60_f7_w_jerUp, "Sig60_fail_jet_pt_soft_wide11_jerUp")

		ofile.WriteObject(self.Sig60_p7_w_jerDown, "Sig60_pass_jet_pt_soft_wide11_jerDown")
		ofile.WriteObject(self.Sig60_f7_w_jerDown, "Sig60_fail_jet_pt_soft_wide11_jerDown")
		
		ofile.WriteObject(self.Sig60_p7_w_jesUp, "Sig60_pass_jet_pt_soft_wide11_jesUp")
		ofile.WriteObject(self.Sig60_f7_w_jesUp, "Sig60_fail_jet_pt_soft_wide11_jesUp")

		ofile.WriteObject(self.Sig60_p7_w_jesDown, "Sig60_pass_jet_pt_soft_wide11_jesDown")
		ofile.WriteObject(self.Sig60_f7_w_jesDown, "Sig60_fail_jet_pt_soft_wide11_jesDown")
