...
#	print(mpt[i][2])
    ...
    cb.set_label("Ratio")
    fig.savefig("MCTF_msdpt_2017_sig135v3.png",bbox="tight")
    plt.clf()
    ...
    cb = fig.colorbar(h[3],ax=ax)
    cb.set_label("Ratio")
    fig.savefig("MCTF_rhopt_2017_sig135v3.png",bbox="tight")
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BasisPoly('CMS_EXO24027_tf_dataResidual_2017', (2, 4), ['pt', 'rho'] ,basis='Bernstein', limits=(-100, 100))
