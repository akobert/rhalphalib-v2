...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.Sig120_p7_w = self.s1.Get("jet_pt_soft_pass_wide11_wide")
		self.Sig120_f7_w = self.s1.Get("jet_pt_soft_fail_wide11_wide")
		
		self.Sig120_p1 = self.s1.Get("pass_soft")	
		self.Sig120_f1 = self.s1.Get("fail_soft")	
		
		self.Sig120_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_puUp")
		self.Sig120_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_puUp")
		self.Sig120_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig120_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig120_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_puDown")
		self.Sig120_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_puDown")
		self.Sig120_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig120_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig120_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerUp")
		self.Sig120_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerUp")
		self.Sig120_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig120_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig120_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jerDown")
		self.Sig120_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jerDown")
		self.Sig120_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig120_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig120_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesUp")
		self.Sig120_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesUp")
		self.Sig120_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig120_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig120_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide11_wide_jesDown")
		self.Sig120_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide11_wide_jesDown")
		...
		ofile.WriteObject(self.Sig120_p7_w, "Sig120_pass_jet_pt_soft_wide11")
		ofile.WriteObject(self.Sig120_f7_w, "Sig120_fail_jet_pt_soft_wide11")
		ofile.WriteObject(self.Sig120_p1, "Sig120_pass_soft")
		ofile.WriteObject(self.Sig120_f1, "Sig120_fail_soft")
		
		ofile.WriteObject(self.Sig120_p7_w_puUp, "Sig120_pass_jet_pt_soft_wide11_puUp")
		ofile.WriteObject(self.Sig120_f7_w_puUp, "Sig120_fail_jet_pt_soft_wide11_puUp")
		ofile.WriteObject(self.Sig120_p1_puUp, "Sig120_pass_soft_puUp")
		ofile.WriteObject(self.Sig120_f1_puUp, "Sig120_fail_soft_puUp")

		ofile.WriteObject(self.Sig120_p7_w_puDown, "Sig120_pass_jet_pt_soft_wide11_puDown")
		ofile.WriteObject(self.Sig120_f7_w_puDown, "Sig120_fail_jet_pt_soft_wide11_puDown")
		...
		ofile.WriteObject(self.Sig120_p7_w_jerUp, "Sig120_pass_jet_pt_soft_wide11_jerUp")
		ofile.WriteObject(self.Sig120_f7_w_jerUp, "Sig120_fail_jet_pt_soft_wide11_jerUp")
		...
		ofile.WriteObject(self.Sig120_p7_w_jerDown, "Sig120_pass_jet_pt_soft_wide11_jerDown")
		ofile.WriteObject(self.Sig120_f7_w_jerDown, "Sig120_fail_jet_pt_soft_wide11_jerDown")
		...
		ofile.WriteObject(self.Sig120_p7_w_jesUp, "Sig120_pass_jet_pt_soft_wide11_jesUp")
		ofile.WriteObject(self.Sig120_f7_w_jesUp, "Sig120_fail_jet_pt_soft_wide11_jesUp")
		...
		ofile.WriteObject(self.Sig120_p7_w_jesDown, "Sig120_pass_jet_pt_soft_wide11_jesDown")
		ofile.WriteObject(self.Sig120_f7_w_jesDown, "Sig120_fail_jet_pt_soft_wide11_jesDown")
