...
def setDict(year):
	...
	if year == "2018" or year == "2018_ParticleNet" or year == "2018_ParticleNet_Retrain" or year == "2018_mixed":
		theory_xsec['M10'] = 25390.0/501525.0
		theory_xsec['M20'] = 15660.0/493822.0
		theory_xsec['M25'] = 13290.0/496157.0
		theory_xsec['M50'] = 8049.0/492039.0
	...
	elif year == "2017" or year == "2017_stable" or year == "2017_ParticleNet" or year == "2017_mixed":
	...
	elif year == "2016" or year == "2016_ParticleNet" or year == "2016_mixed":	
...
#		LUMI = 1.681
	...
	if year == "2018" or year == "2018_ParticleNet" or year == "2018_ParticleNet_Retrain" or year == "2018_mixed":
		LUMI = 59.82
	if year == "Combined" or year == "Run2" or year == "Run2_23" or year == "Run2_mixed":
		LUMI = 137.61
	...
	if year == "Combined_ParticleNet_Allv5":
		LUMI = 13.761
	if year == "total_5bin" or year == "total_4bin" or year == "pass_5bin" or year == "pass_4bin" or year == "pass_4bin_V2" or year == "pass_4bin_V3" or year == "pass_4bin_V4" or year == "pass_4bin_V5":
		LUMI = 13.761
	...
	for mass in masses:
		files["M"+mass] = "/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/"+year+"/sig"+mass+""+order+"/higgsCombineTest.AsymptoticLimits.mH120.root"	
		files_comp["M"+mass] = "/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/"+year_comp+"/sig"+mass+"_low"+order+"/higgsCombineTest.AsymptoticLimits.mH120.root"	
		
	yellowList, greenList, medianList, obsList, marcObsList, marcExpectList = plotLimits(year, poly1, masses, files, scale)
	yellowList_comp, greenList_comp, medianList_comp, obsList_comp, marcObsList_comp, marcExpectList_comp = plotLimits(year_comp, poly1, masses, files_comp, scale)
...
#		medianList.Draw('PLsame')
	...
	obsList_comp.SetLineColor(kRed)
	obsList_comp.SetMarkerColor(kRed)
        obsList_comp.SetLineWidth(3)
        obsList_comp.SetLineStyle(1)
        obsList_comp.SetMarkerStyle(20)
        obsList_comp.SetMarkerSize(1.5)
	obsList_comp.Draw('LPsame')
        
        medianList_comp.SetLineColor(kRed)
        medianList_comp.SetLineWidth(3)
        medianList_comp.SetLineStyle(2)
        medianList_comp.SetMarkerStyle(20)
        medianList_comp.SetMarkerSize(1.5)
	medianList_comp.Draw('Lsame')
...
#		legend.AddEntry(obs, "Observed",'l')
	...
	legend.AddEntry(yellowList,"Expected #pm 2 s.d.",'lf')
        ...
        legend.AddEntry(obsList_comp, "2,2 Polynomial Observed Limits", 'CL')
        legend.AddEntry(medianList_comp, "2,2 Polynomial Expected Limits", 'CL')
        if scaled_lumi == "0":
	...
	if scaled_lumi != "0":
		c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_"+year+""+order+"_scaled_comparison.png")
	else:
		c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_"+year+""+order+"_comparison.png")
