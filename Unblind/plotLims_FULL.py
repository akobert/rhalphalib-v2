...
#	h_limit.SetMinimum(0.02)
#	h_limit.SetMaximum(0.4)
...
#		legend.AddEntry(obs, "Observed",'l')
	...
	if marc: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_FULL_marc.png")
	else: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_FULL.png")
	
	c.SetLogx() # Setting Log X to match Marc
	h_limit.GetXaxis().SetLimits(6,500)
	if marc: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_FULL_marc_log.png")
	else: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_FULL_log.png")
