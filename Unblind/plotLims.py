...
#	parser = OptionParser()
	...
	poly2 = sys.argv[3]
        ...
        if len(sys.argv) > 5:
            additional_limit = sys.argv[5]
            if additional_limit == "Marc":
                marc = True
		print("Adding Marc Limits")
        else:
            marc = False
...
#		legend.AddEntry(obs, "Observed",'l')
	...
	if scaled_lumi != "0":
		c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_"+year+""+order+"_scaled.png")
	else:
		c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_"+year+""+order+".png")
