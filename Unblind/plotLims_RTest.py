...
#		LUMI = 1.681
	...
	for mass in masses:
		if mass in generated_masses:
			...
			files["M"+mass] = "/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/Run2_RTest/sig"+mass+"/higgsCombineTest.AsymptoticLimits.mH120.root"	
...
#		legend.AddEntry(obs, "Observed",'l')
	...
	if marc: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_RTest_marc.png")
	else: c.SaveAs("/home/akobert/CMSSW_11_3_4/src/FitTest/Unblind/limits/limits_RTest.png")
