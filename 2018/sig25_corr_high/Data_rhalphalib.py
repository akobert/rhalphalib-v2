...
#        SF = json.load(f)
    ...
    tf_MCtempl = rl.BasisPoly('tf_MCtempl', (4, 4), ['pt', 'rho'], basis='Bernstein', init_params=initial_vals, limits=(-100, 100))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BasisPoly('tf_dataResidual', (4, 4), ['pt', 'rho'] ,basis='Bernstein', limits=(-100, 100))
