...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, dfile1, sfile1):
		...
		self.Sig150_p7_w = self.s1.Get("jet_pt_soft_pass_wide13_wide")
		self.Sig150_f7_w = self.s1.Get("jet_pt_soft_fail_wide13_wide")
		
		self.Sig150_p1 = self.s1.Get("pass_soft")	
		self.Sig150_f1 = self.s1.Get("fail_soft")	
		
		self.Sig150_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_puUp")
		self.Sig150_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_puUp")
		self.Sig150_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig150_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig150_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_puDown")
		self.Sig150_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_puDown")
		self.Sig150_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig150_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig150_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_jerUp")
		self.Sig150_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_jerUp")
		self.Sig150_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig150_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig150_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_jerDown")
		self.Sig150_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_jerDown")
		self.Sig150_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig150_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig150_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide13_wide_jesUp")
		self.Sig150_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide13_wide_jesUp")
		self.Sig150_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig150_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig150_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide13_wide_jesDown")
		self.Sig150_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide13_wide_jesDown")
		...
		ofile.WriteObject(self.Sig150_p7_w, "Sig150_pass_jet_pt_soft_wide13")
		ofile.WriteObject(self.Sig150_f7_w, "Sig150_fail_jet_pt_soft_wide13")
		ofile.WriteObject(self.Sig150_p1, "Sig150_pass_soft")
		ofile.WriteObject(self.Sig150_f1, "Sig150_fail_soft")
		
		ofile.WriteObject(self.Sig150_p7_w_puUp, "Sig150_pass_jet_pt_soft_wide13_puUp")
		ofile.WriteObject(self.Sig150_f7_w_puUp, "Sig150_fail_jet_pt_soft_wide13_puUp")
		ofile.WriteObject(self.Sig150_p1_puUp, "Sig150_pass_soft_puUp")
		ofile.WriteObject(self.Sig150_f1_puUp, "Sig150_fail_soft_puUp")

		ofile.WriteObject(self.Sig150_p7_w_puDown, "Sig150_pass_jet_pt_soft_wide13_puDown")
		ofile.WriteObject(self.Sig150_f7_w_puDown, "Sig150_fail_jet_pt_soft_wide13_puDown")
		...
		ofile.WriteObject(self.Sig150_p7_w_jerUp, "Sig150_pass_jet_pt_soft_wide13_jerUp")
		ofile.WriteObject(self.Sig150_f7_w_jerUp, "Sig150_fail_jet_pt_soft_wide13_jerUp")
		...
		ofile.WriteObject(self.Sig150_p7_w_jerDown, "Sig150_pass_jet_pt_soft_wide13_jerDown")
		ofile.WriteObject(self.Sig150_f7_w_jerDown, "Sig150_fail_jet_pt_soft_wide13_jerDown")
		...
		ofile.WriteObject(self.Sig150_p7_w_jesUp, "Sig150_pass_jet_pt_soft_wide13_jesUp")
		ofile.WriteObject(self.Sig150_f7_w_jesUp, "Sig150_fail_jet_pt_soft_wide13_jesUp")
		...
		ofile.WriteObject(self.Sig150_p7_w_jesDown, "Sig150_pass_jet_pt_soft_wide13_jesDown")
		ofile.WriteObject(self.Sig150_f7_w_jesDown, "Sig150_fail_jet_pt_soft_wide13_jesDown")
