...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    pts = np.array([120, 135, 150, 170, 200, 700])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins12[6] = {120, 135, 150, 170, 200, 700};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins12, 40, 0, 2000)
