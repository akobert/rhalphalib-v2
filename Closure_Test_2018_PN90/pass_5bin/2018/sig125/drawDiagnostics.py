...
def drawDiagnostic(name, ifile1, mass):
	gROOT.SetBatch(True)
	Sigs = [["/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL/M125_UL_nano_merged.root"], "5.982*7639.0/567896.0", "", "sig125_nano", "125 GeV Signal", "7639.0"]
	sig_name = "sig125_nano"
	ptBins = [120, 150, 180, 210, 260, 700]
