...
def test_rhalphabet(tmpdir,
    ...
    initial_vals = initial_vals.reshape(4, 5)
    print(initial_vals)

    tf_MCtempl = rl.BasisPoly('CMS_EXO24027_tf_MCtempl', (3, 4), ['pt', 'rho'], basis='Bernstein', init_params=initial_vals, limits=(-100, 100))
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BasisPoly('CMS_EXO24027_tf_dataResidual_2018', (3, 4), ['pt', 'rho'] ,basis='Bernstein', limits=(-100, 100))
