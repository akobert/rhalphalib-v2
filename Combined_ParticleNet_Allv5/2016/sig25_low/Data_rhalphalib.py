...
def plot_mctf(tf_MCtempl, msdbins, GJeff):
    ...
    ROOT.gInterpreter.Declare("Double_t widebins6[6] = {200, 230, 255, 290, 360, 1000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 5, widebins6, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([200, 230, 255, 290, 360, 1000])
    npt = len(ptbins) - 1
    ...
    rhopts = 2*np.log(msdpts/ptpts)
    print(rhopts)
    ptscaled = (ptpts - 200.0) / (1000.0 - 200.0)
