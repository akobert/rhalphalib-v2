...
class Build:
	def __init__(self, name, bfile1, bfile2, bfile3, bfile4, bfile5, bfile6, bfile7, bfile8, dfile1, dfile2, sfile1, sfile2):
		...
		self.Sig20_p7_w = self.s1.Get("jet_pt_soft_pass_wide6_wide")
		self.Sig20_f7_w = self.s1.Get("jet_pt_soft_fail_wide6_wide")
		
		self.Sig20_p1 = self.s1.Get("pass_soft")	
		self.Sig20_f1 = self.s1.Get("fail_soft")	
		
		self.Sig20_p7_w_puUp = self.s1.Get("jet_pt_soft_pass_wide6_wide_puUp")
		self.Sig20_f7_w_puUp = self.s1.Get("jet_pt_soft_fail_wide6_wide_puUp")
		self.Sig20_p1_puUp = self.s1.Get("pass_soft_puUp")	
		self.Sig20_f1_puUp = self.s1.Get("fail_soft_puUp")	
		
		self.Sig20_p7_w_puDown = self.s1.Get("jet_pt_soft_pass_wide6_wide_puDown")
		self.Sig20_f7_w_puDown = self.s1.Get("jet_pt_soft_fail_wide6_wide_puDown")
		self.Sig20_p1_puDown = self.s1.Get("pass_soft_puDown")	
		self.Sig20_f1_puDown = self.s1.Get("fail_soft_puDown")	
		
		self.Sig20_p7_w_jerUp = self.s1.Get("jet_pt_soft_pass_wide6_wide_jerUp")
		self.Sig20_f7_w_jerUp = self.s1.Get("jet_pt_soft_fail_wide6_wide_jerUp")
		self.Sig20_p1_jerUp = self.s1.Get("pass_soft_jerUp")	
		self.Sig20_f1_jerUp = self.s1.Get("fail_soft_jerUp")	
		
		self.Sig20_p7_w_jerDown = self.s1.Get("jet_pt_soft_pass_wide6_wide_jerDown")
		self.Sig20_f7_w_jerDown = self.s1.Get("jet_pt_soft_fail_wide6_wide_jerDown")
		self.Sig20_p1_jerDown = self.s1.Get("pass_soft_jerDown")	
		self.Sig20_f1_jerDown = self.s1.Get("fail_soft_jerDown")	
		
		self.Sig20_p7_w_jesUp = self.s1.Get("jet_pt_soft_pass_wide6_wide_jesUp")
		self.Sig20_f7_w_jesUp = self.s1.Get("jet_pt_soft_fail_wide6_wide_jesUp")
		self.Sig20_p1_jesUp = self.s1.Get("pass_soft_jesUp")	
		self.Sig20_f1_jesUp = self.s1.Get("fail_soft_jesUp")	
		
		self.Sig20_p7_w_jesDown = self.s1.Get("jet_pt_soft_pass_wide6_wide_jesDown")
		self.Sig20_f7_w_jesDown = self.s1.Get("jet_pt_soft_fail_wide6_wide_jesDown")
		...
		self.Sig20_APV_p7_w = self.s2.Get("jet_pt_soft_pass_wide6_wide")
		self.Sig20_APV_f7_w = self.s2.Get("jet_pt_soft_fail_wide6_wide")
		
		self.Sig20_APV_p1 = self.s2.Get("pass_soft")	
		self.Sig20_APV_f1 = self.s2.Get("fail_soft")	
		
		self.Sig20_APV_p7_w_puUp = self.s2.Get("jet_pt_soft_pass_wide6_wide_puUp")
		self.Sig20_APV_f7_w_puUp = self.s2.Get("jet_pt_soft_fail_wide6_wide_puUp")
		self.Sig20_APV_p1_puUp = self.s2.Get("pass_soft_puUp")	
		self.Sig20_APV_f1_puUp = self.s2.Get("fail_soft_puUp")	
		
		self.Sig20_APV_p7_w_puDown = self.s2.Get("jet_pt_soft_pass_wide6_wide_puDown")
		self.Sig20_APV_f7_w_puDown = self.s2.Get("jet_pt_soft_fail_wide6_wide_puDown")
		self.Sig20_APV_p1_puDown = self.s2.Get("pass_soft_puDown")	
		self.Sig20_APV_f1_puDown = self.s2.Get("fail_soft_puDown")	
		
		self.Sig20_APV_p7_w_jerUp = self.s2.Get("jet_pt_soft_pass_wide6_wide_jerUp")
		self.Sig20_APV_f7_w_jerUp = self.s2.Get("jet_pt_soft_fail_wide6_wide_jerUp")
		self.Sig20_APV_p1_jerUp = self.s2.Get("pass_soft_jerUp")	
		self.Sig20_APV_f1_jerUp = self.s2.Get("fail_soft_jerUp")	
		
		self.Sig20_APV_p7_w_jerDown = self.s2.Get("jet_pt_soft_pass_wide6_wide_jerDown")
		self.Sig20_APV_f7_w_jerDown = self.s2.Get("jet_pt_soft_fail_wide6_wide_jerDown")
		self.Sig20_APV_p1_jerDown = self.s2.Get("pass_soft_jerDown")	
		self.Sig20_APV_f1_jerDown = self.s2.Get("fail_soft_jerDown")	
		
		self.Sig20_APV_p7_w_jesUp = self.s2.Get("jet_pt_soft_pass_wide6_wide_jesUp")
		self.Sig20_APV_f7_w_jesUp = self.s2.Get("jet_pt_soft_fail_wide6_wide_jesUp")
		self.Sig20_APV_p1_jesUp = self.s2.Get("pass_soft_jesUp")	
		self.Sig20_APV_f1_jesUp = self.s2.Get("fail_soft_jesUp")	
		
		self.Sig20_APV_p7_w_jesDown = self.s2.Get("jet_pt_soft_pass_wide6_wide_jesDown")
		self.Sig20_APV_f7_w_jesDown = self.s2.Get("jet_pt_soft_fail_wide6_wide_jesDown")
