...
def get_template(sName, passed, ptbin, obs, syst, muon=False):
    ...
    name = sName+'_'+name+'_'+"jet_pt_soft_wide14"
...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 120, 150, 180, 210, 260, 700 ,900, 1200, 1500, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins14[10] = {0, 120, 150, 180, 210, 260, 700 ,900, 1200, 1500, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 9, widebins14, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([120, 150, 180, 210, 260, 700])
    npt = len(ptbins) - 1
