...
def get_template(sName, passed, ptbin, obs, syst, muon=False):
    ...
    name = sName+'_'+name+'_'+"jet_pt_soft_wide12"
...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 120, 135, 150, 170, 200, 700 ,900, 1200, 1500, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins12[10] = {0, 120, 135, 150, 170, 200, 700 ,900, 1200, 1500, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 9, widebins12, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([120, 135, 150, 170, 200, 700])
    npt = len(ptbins) - 1
...
#    plot_mctf(tf_MCtempl,msdbins)
    ...
    tf_dataResidual = rl.BasisPoly('CMS_EXO24027_tf_dataResidual_2018', (3, 3), ['pt', 'rho'] ,basis='Bernstein', limits=(-100, 100))
