...
def drawDiagnostic(name, ifile1, mass):
	gROOT.SetBatch(True)
	Sigs = [["/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL/M150_UL_nano_merged.root"], "5.982*7639.0/567896.0", "", "sig150_nano", "150 GeV Signal", "7639.0"]
	sig_name = "sig150_nano"
	ptBins = [120, 135, 150, 170, 200, 700]
