...
def get_template(sName, passed, ptbin, obs, syst, muon=False):
    ...
    name = sName+'_'+name+'_'+"jet_pt_soft_wide9"
...
def plot_mctf(tf_MCtempl, msdbins):
    ...
    pts = np.array([0, 220, 250, 285, 340, 700, 2000])
    ...
    ROOT.gInterpreter.Declare("Double_t widebins9[9] = {0, 220, 250, 285, 340, 700, 2000};")
    mpt_TF = TH2F("mpt_TF", "Mass vs. pT Transfer Factor", 7, widebins9, 40, 0, 2000)
...
def test_rhalphabet(tmpdir,
    ...
    # define bins    
    ptbins = np.array([220, 250, 285, 340, 700])
    npt = len(ptbins) - 1
